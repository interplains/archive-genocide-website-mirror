...
If you find a security problem with the mirror â€” a way to leak data, execute code, break out
of the read-only viewer, deanonymize a visitor, or otherwise put people at risk â€”
...
Please include enough detail to reproduce it. We'll confirm the report, work on a fix, and â€”
if you'd like â€” credit you once it's resolved. Please give us reasonable time to patch before
disclosing publicly.
...
- Submit footage or source material through a security report. Sources are protected **only**
  through the official submission channel above â€” never through this repository or any form on
  a mirror.
